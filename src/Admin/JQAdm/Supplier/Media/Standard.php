	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 */
	protected function deleteMediaItems( \Aimeos\MShop\Supplier\Item\Iface $item, iterable $listItems )
	{
		$context = $this->context();
		...
		{
			$func = $search->make( 'supplier:has', ['media', $listItem->getType(), $listItem->getRefId()] );
	...
	{
		/** admin/jqadm/supplier/media/subparts
		 ...
		 * @since 2017.07
		 */
		return (array) $this->context()->config()->get( 'admin/jqadm/supplier/media/subparts', [] );
	}
