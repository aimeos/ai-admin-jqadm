...
namespace Aimeos\Admin\JQAdm\Dashboard\Order\Quick\Countcustomer;

sprintf( 'quick/countcustomer' ); // for translation


/**
 * Default implementation of dashboard quick/countcustomer JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/dashboard/order/quick/countcustomer/name
	...
	public function getSubClient( string $type, ?string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/quick/countcustomer/decorators/global
		 * @see admin/jqadm/dashboard/order/quick/countcustomer/decorators/local
		 */
		 ...
		 * @since 2021.04
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/dashboard/order/quick/countcustomer/decorators/excludes
		 * @see admin/jqadm/dashboard/order/quick/countcustomer/decorators/local
		 */
		 ...
		 * @see admin/jqadm/dashboard/order/quick/countcustomer/decorators/global
		 */
		return $this->createSubClient( 'dashboard/order/quick/countcustomer/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/dashboard/order/quick/countcustomer/subparts
		 ...
		 * @since 2021.04
		 */
		return (array) $this->context()->config()->get( 'admin/jqadm/dashboard/order/quick/countcustomer/subparts', [] );
	}
}
