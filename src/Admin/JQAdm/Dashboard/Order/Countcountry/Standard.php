...
sprintf( 'countcountry' ); // for translation


/**
 * Default implementation of dashboard countcountry JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/dashboard/order/countcountry/name
	...
	public function search() : ?string
	{
		...
		$view->ordercountcountryLabels = $this->context()->i18n()->all( 'country' );
	...
	public function getSubClient( string $type, ?string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/countcountry/decorators/global
		 */
		return $this->createSubClient( 'dashboard/order/countcountry/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/dashboard/order/countcountry/subparts
		 ...
		 * @since 2021.04
		 */
		return (array) $this->context()->config()->get( 'admin/jqadm/dashboard/order/countcountry/subparts', [] );
	}
}
