	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'media/lists' );
	}
	...
	{
		return $this->copyBase( 'media/lists' );
	}
	...
	{
		return $this->createBase( 'media/lists' );
	}
	...
	{
		return $this->deleteBase( 'media/lists' );
	}
	...
	{
		return $this->getBase( 'media/lists' );
	}
	...
	{
		return $this->saveBase( 'media/lists' );
	}
	...
	{
		$view = $this->searchBase( 'media/lists' );
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/media/lists/decorators/local
		 */
		 ...
		 * @see admin/jqadm/type/media/lists/decorators/global
		 */
		return $this->createSubClient( 'type/media/lists' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/media/lists/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/media/lists/subparts', [] );
	}
