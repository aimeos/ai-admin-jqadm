...
/**
 * Factory for customer property type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a customer property type client object
	 *
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'admin/jqadm/type/customer/property/name', 'Standard' );
		}
