	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'customer/property' );
	}
	...
	{
		return $this->copyBase( 'customer/property' );
	}
	...
	{
		return $this->createBase( 'customer/property' );
	}
	...
	{
		return $this->deleteBase( 'customer/property' );
	}
	...
	{
		return $this->getBase( 'customer/property' );
	}
	...
	{
		return $this->saveBase( 'customer/property' );
	}
	...
	{
		$view = $this->searchBase( 'customer/property' );
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/customer/property/decorators/local
		 */
		 ...
		 * @see admin/jqadm/type/customer/property/decorators/global
		 */
		return $this->createSubClient( 'type/customer/property' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/customer/property/subparts
		 ...
		 * @since 2018.01
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/customer/property/subparts', [] );
	}
