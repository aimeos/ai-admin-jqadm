	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'text/lists' );
	}
	...
	{
		return $this->copyBase( 'text/lists' );
	}
	...
	{
		return $this->createBase( 'text/lists' );
	}
	...
	{
		return $this->deleteBase( 'text/lists' );
	}
	...
	{
		return $this->getBase( 'text/lists' );
	}
	...
	{
		return $this->saveBase( 'text/lists' );
	}
	...
	{
		$view = $this->searchBase( 'text/lists' );
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/text/lists/decorators/global
		 */
		return $this->createSubClient( 'type/text/lists' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/text/lists/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/text/lists/subparts', [] );
	}
