	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		/** admin/jqadm/type/text/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/text/subparts', [] );
	}
