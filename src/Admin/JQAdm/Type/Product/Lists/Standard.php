	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'product/lists' );
	}
	...
	{
		return $this->copyBase( 'product/lists' );
	}
	...
	{
		return $this->createBase( 'product/lists' );
	}
	...
	{
		return $this->deleteBase( 'product/lists' );
	}
	...
	{
		return $this->getBase( 'product/lists' );
	}
	...
	{
		return $this->saveBase( 'product/lists' );
	}
	...
	{
		$view = $this->searchBase( 'product/lists' );
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/product/lists/decorators/global
		 */
		return $this->createSubClient( 'type/product/lists' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/product/lists/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/product/lists/subparts', [] );
	}
