	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'catalog/lists' );
	}
	...
	{
		return $this->copyBase( 'catalog/lists' );
	}
	...
	{
		return $this->createBase( 'catalog/lists' );
	}
	...
	{
		return $this->deleteBase( 'catalog/lists' );
	}
	...
	{
		return $this->getBase( 'catalog/lists' );
	}
	...
	{
		return $this->saveBase( 'catalog/lists' );
	}
	...
	{
		$view = $this->searchBase( 'catalog/lists' );
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/catalog/lists/decorators/global
		 */
		return $this->createSubClient( 'type/catalog/lists' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/catalog/lists/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/catalog/lists/subparts', [] );
	}
