	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'price/lists' );
	}
	...
	{
		return $this->copyBase( 'price/lists' );
	}
	...
	{
		return $this->createBase( 'price/lists' );
	}
	...
	{
		return $this->deleteBase( 'price/lists' );
	}
	...
	{
		return $this->getBase( 'price/lists' );
	}
	...
	{
		return $this->saveBase( 'price/lists' );
	}
	...
	{
		$view = $this->searchBase( 'price/lists' );
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/price/lists/decorators/global
		 */
		return $this->createSubClient( 'type/price/lists' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/price/lists/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/price/lists/subparts', [] );
	}
