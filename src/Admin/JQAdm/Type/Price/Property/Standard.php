...
sprintf( 'type/price/property' ); // for translation
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->batchBase( 'price/property' );
	}
	...
	{
		return $this->copyBase( 'price/property' );
	}
	...
	{
		return $this->createBase( 'price/property' );
	}
	...
	{
		return $this->deleteBase( 'price/property' );
	}
	...
	{
		return $this->getBase( 'price/property' );
	}
	...
	{
		return $this->saveBase( 'price/property' );
	}
	...
	{
		$view = $this->searchBase( 'price/property' );

		/** admin/jqadm/type/price/property/template-list
		 ...
		 * @since 2016.04
		 */
		$tplconf = 'admin/jqadm/type/price/property/template-list';
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/price/property/decorators/global
		 * @see admin/jqadm/type/price/property/decorators/local
		 */
		 ...
		 * @since 2017.10
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/type/price/property/decorators/excludes
		 * @see admin/jqadm/type/price/property/decorators/local
		 */
		 ...
		 * @see admin/jqadm/type/price/property/decorators/global
		 */
		return $this->createSubClient( 'type/price/property' . $type, $name );
	}
	...
	{
		/** admin/jqadm/type/price/property/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/price/property/subparts', [] );
	}
	...
	{
		/** admin/jqadm/type/price/property/template-item
		 ...
		 * @since 2017.10
		 */
		$tplconf = 'admin/jqadm/type/price/property/template-item';
