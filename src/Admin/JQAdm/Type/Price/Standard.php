	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		/** admin/jqadm/type/price/subparts
		 ...
		 * @since 2017.10
		 */
		return $this->context()->config()->get( 'admin/jqadm/type/price/subparts', [] );
	}
