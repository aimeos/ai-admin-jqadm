...
namespace Aimeos\Admin\JQAdm\Settings\Api\Removebg;
...
{
	/** admin/jqadm/settings/api/removebg/name
	...
	{
		$data = array_filter( (array) $this->view()->param( 'api/removebg', [] ), fn( $val ) => $val !== '' && $val !== null );
	...
	public function getSubClient( string $type, ?string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/settings/api/removebg/decorators/global
		 * @see admin/jqadm/settings/api/removebg/decorators/local
		 */
		 ...
		 * @since 2024.10
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/settings/api/removebg/decorators/excludes
		 * @see admin/jqadm/settings/api/removebg/decorators/local
		 */
		 ...
		 * @see admin/jqadm/settings/api/removebg/decorators/global
		 */
		return $this->createSubClient( 'settings/api/removebg/' . $type, $name );
	}
	...
	{
		return (array) $this->context()->config()->get( 'admin/jqadm/settings/api/removebg/subparts', [] );
	}
	...
	{
		/** admin/jqadm/settings/api/removebg/template-item
		 ...
		 * @since 2016.04
		 */
		$tplconf = 'admin/jqadm/settings/api/removebg/template-item';
