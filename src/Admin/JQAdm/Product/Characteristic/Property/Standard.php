	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function save() : ?string
	{
		...
		// @phpstan-ignore argument.type
		$this->fromArray( $view->item, (array) $view->param( 'characteristic/property', [] ) );
	...
	protected function excludeItems( \Aimeos\Map $propItems ) : \Aimeos\Map
	{
		...
		return $propItems->filter( function( $item ) use ( $excludes ) {
			return !in_array( $item->getType(), (array) $excludes );
		} );
	}
	...
	protected function getSubClientNames() : array
	{
		 ...
		 * @since 2016.01
		 */
		return (array) $this->context()->config()->get( 'admin/jqadm/product/characteristic/property/subparts', [] );
	}
