...
{
	/** admin/jqadm/product/price/property/name
	...
	public function copy() : ?string
	{
		...
		$view->priceData = $this->toArray( $view->item, (array) $view->get( 'priceData', [] ), true );
	...
	public function get() : ?string
	{
		$view = $this->object()->data( $this->view() );
		// @phpstan-ignore argument.type
		$view->priceData = $this->toArray( $view->item, (array) $view->get( 'priceData', [] ) );
	...
	public function getSubClient( string $type, ?string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/product/price/property/decorators/local
		 */
		 ...
		 * @since 2019.07
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/product/price/property/decorators/excludes
		 * @see admin/jqadm/product/price/property/decorators/local
		 */
	...
	{
		/** admin/jqadm/product/price/property/subparts
		 ...
		 * @since 2019.07
		 */
		return (array) $this->context()->config()->get( 'admin/jqadm/product/price/property/subparts', [] );
	}
	 ...
	 */
	protected function toArray( \Aimeos\MShop\Product\Item\Iface $item, array $data, bool $copy = false ) : array
	{
		$idx = 0;
		$siteId = $this->context()->locale()->getSiteId();
	...
	{
		/** admin/jqadm/product/price/property/template-item
		 ...
		 * @since 2019.07
		 */
		$tplconf = 'admin/jqadm/product/price/property/template-item';
