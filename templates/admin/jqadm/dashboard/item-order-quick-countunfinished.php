...
?>
<div class="quick order-quick-countunfinished col-sm-6 col-xl-3" title="<?= $enc->attr( $this->translate( 'admin', 'Unfinished orders within the last seven days compared to the period before' ) ) ?>">
