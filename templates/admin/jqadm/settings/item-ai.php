...
?>
<div id="ai" class="item-ai tab-pane fade" role="tabpanel" aria-labelledby="ai">
	<div class="row">
					...
					<div class="form-group row mandatory">
						...
						<div class="col-sm-8">
							<input class="form-control" required tabindex="<?= $this->get( 'tabindex' ) ?>"
								name="<?= $enc->attr( $this->formparam( ['ai', $action, 'provider'] ) ) ?>"
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input class="form-control" tabindex="<?= $this->get( 'tabindex' ) ?>"
									name="<?= $enc->attr( $this->formparam( ['ai', $action, 'model'] ) ) ?>"
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input class="form-control" type="password" autocomplete="new-password" tabindex="<?= $this->get( 'tabindex' ) ?>"
								name="<?= $enc->attr( $this->formparam( ['ai', $action, 'api_key'] ) ) ?>"
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input class="form-control" type="url" tabindex="<?= $this->get( 'tabindex' ) ?>"
								name="<?= $enc->attr( $this->formparam( ['ai', $action, 'url'] ) ) ?>"
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<textarea class="form-control" rows="3" tabindex="<?= $this->get( 'tabindex' ) ?>"
								name="<?= $enc->attr( $this->formparam( ['ai', $action, 'extra'] ) ) ?>"
