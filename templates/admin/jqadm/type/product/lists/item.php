					...
					<div class="row">
						...
						<div class="col-xl-6 block <?= $this->site()->readonly( $this->get( 'itemData/product.lists.type.siteid' ) ) ?>">
							<translations tabindex="1"
								:value="<?= $enc->attr( $this->get( 'itemData/product.lists.type.i18n', new \stdClass ) ) ?>"
								:name="`<?= $enc->js( $this->formparam( array( 'item', 'product.lists.type.i18n' ) ) ) ?>`"
								:readonly="`<?= $this->site()->readonly( $this->get( 'itemData/product.lists.type.siteid' ) ) ?>` ? true : false"
