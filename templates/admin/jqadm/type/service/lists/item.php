					...
					<div class="row">
						...
						<div class="col-xl-6 block <?= $this->site()->readonly( $this->get( 'itemData/service.lists.type.siteid' ) ) ?>">
							<translations tabindex="1"
								:value="<?= $enc->attr( $this->get( 'itemData/service.lists.type.i18n', new \stdClass ) ) ?>"
								:name="`<?= $enc->js( $this->formparam( array( 'item', 'service.lists.type.i18n' ) ) ) ?>`"
								:readonly="`<?= $this->site()->readonly( $this->get( 'itemData/service.lists.type.siteid' ) ) ?>` ? true : false"
