					...
					<div class="row">
						...
						<div class="col-xl-6 block <?= $this->site()->readonly( $this->get( 'itemData/text.lists.type.siteid' ) ) ?>">
							<translations tabindex="1"
								:value="<?= $enc->attr( $this->get( 'itemData/text.lists.type.i18n', new \stdClass ) ) ?>"
								:name="`<?= $enc->js( $this->formparam( array( 'item', 'text.lists.type.i18n' ) ) ) ?>`"
								:readonly="`<?= $this->site()->readonly( $this->get( 'itemData/text.lists.type.siteid' ) ) ?>` ? true : false"
