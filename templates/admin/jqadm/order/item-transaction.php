...
?>
<div id="transaction" class="item-transaction tab-pane fade box" role="tabpanel" aria-labelledby="transaction">
				...
				<tbody>
					<?php foreach( $service->getTransactions() as $txItem ) : ?>
						<tr>
							...
							<td class="transaction-data"><?= str_replace( ',', '<br>', $enc->html( trim( json_encode( $txItem->getData() ) ), '{}' ) ) ?></td>
						</tr>
					<?php endforeach ?>
				</tbody>
			</table>
