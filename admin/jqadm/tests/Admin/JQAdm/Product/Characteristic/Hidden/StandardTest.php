...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Product\Characteristic\Hidden\Standard( $this->context, $templatePaths );
	...
	public function testSave()
	{
		...
		$item->setCode( 'jqadm-test-hidden' );
		$item->setId( null );
		...
		$param = array(
			...
			'characteristic' => array(
				'hidden' => array(
					...
					'product.lists.refid' => array( $attrManager->findItem( '29', [], 'product', 'width' )->getId() ),
				),
			),
		);
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Product\Characteristic\Hidden\Standard' )
