...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Product\Related\Bought\Standard( $this->context, $templatePaths );
	...
	public function testCreate()
	{
		...
		$this->assertContains( 'Bought together', $result );
	...
	public function testSave()
	{
		...
		$item->setCode( 'jqadm-test-bought' );
		$item->setId( null );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Product\Related\Bought\Standard' )
