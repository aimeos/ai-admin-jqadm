...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Catalog\Image\Standard( $this->context );
	...
	public function testSave()
	{
		...
		$typeId = $typeManager->findItem( 'default', [], 'catalog' )->getId();
	...
	{
		$object = $this->getMockBuilder( \Aimeos\Admin\JQAdm\Catalog\Image\Standard::class )
			->setConstructorArgs( array( $this->context, \TestHelperJqadm::getTemplatePaths() ) )
			->setMethods( [$method] )
			->getMock();

		$view = \TestHelperJqadm::getView();
		$view->item = \Aimeos\MShop\Factory::createManager( $this->context, 'catalog' )->createItem();
