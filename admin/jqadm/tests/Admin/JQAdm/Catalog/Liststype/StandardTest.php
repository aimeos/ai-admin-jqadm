...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Catalog\Liststype\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Catalog\Liststype\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'catalog/lists/type' );
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Catalog\Liststype\Standard( $this->context, [] );
	...
	public function testSave()
	{
		...
		$param = array(
			'type' => 'unittest',
			'item' => array(
				'catalog.lists.type.id' => '',
				'catalog.lists.type.status' => '1',
				'catalog.lists.type.domain' => 'product',
				'catalog.lists.type.code' => 'jqadm@test',
				'catalog.lists.type.label' => 'jqadm test',
			),
		);
