...
namespace Aimeos\Admin\JQAdm\Attribute\Liststype;
...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Attribute\Liststype\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Attribute\Liststype\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'attribute/lists/type' );
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Attribute\Liststype\Standard( $this->context, [] );
	...
	public function testSave()
	{
		...
		$param = array(
			'type' => 'unittest',
			'item' => array(
				'attribute.lists.type.id' => '',
				'attribute.lists.type.status' => '1',
				'attribute.lists.type.domain' => 'product',
				'attribute.lists.type.code' => 'jqadm@test',
				'attribute.lists.type.label' => 'jqadm test',
			),
		);
	...
	public function testSearch()
	{
		$param = array(
			...
			'filter' => array(
				'key' => array( 0 => 'attribute.lists.type.code' ),
				'op' => array( 0 => '==' ),
				'val' => array( 0 => 'default' ),
			),
			'sort' => array( '-attribute.lists.type.id' ),
		);
		$helper = new \Aimeos\MW\View\Helper\Param\Standard( $this->view, $param );
		$this->view->addHelper( 'param', $helper );
