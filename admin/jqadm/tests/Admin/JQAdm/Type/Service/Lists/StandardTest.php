...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Service\Lists\Standard( $this->context );
	...
	public function testCreate()
	{
		...
		$this->assertStringContainsString( 'service/lists', $result );
	...
	{
		$manager = \Aimeos\MShop::create( $this->context, 'service/lists/type' );
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Type\Service\Lists\Standard( $this->context, [] );
	...
	public function testSave()
	{
		...
		$param = array(
			'type' => 'unittest',
			'item' => array(
				'service.lists.type.id' => '',
				'service.lists.type.status' => '1',
				'service.lists.type.domain' => 'product',
				'service.lists.type.code' => 'jqadm@test',
				'service.lists.type.label' => 'jqadm test',
			),
		);
	...
	public function testSearch()
	{
		$param = array(
			...
			'filter' => array(
				'key' => array( 0 => 'service.lists.type.code' ),
				'op' => array( 0 => '==' ),
				'val' => array( 0 => 'default' ),
			),
			'sort' => array( '-service.lists.type.id' ),
		);
		$helper = new \Aimeos\MW\View\Helper\Param\Standard( $this->view, $param );
		$this->view->addHelper( 'param', $helper );
	...
	protected function getViewNoRender( $real = true )
	{
		...
		$param = ['site' => 'unittest', 'id' => $real ? $manager->findItem( 'default', [], 'product' )->getId() : -1];
