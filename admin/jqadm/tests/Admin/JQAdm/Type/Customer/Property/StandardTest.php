...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Customer\Property\Standard' )
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Type\Customer\Property\Standard( $this->context, [] );
	...
	public function testSave()
	{
		...
		$manager->deleteItem( $manager->findItem( 'jqadm@test', [], 'customer' )->getId() );
	}
