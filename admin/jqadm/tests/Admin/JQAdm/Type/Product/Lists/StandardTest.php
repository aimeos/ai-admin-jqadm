...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Product\Lists\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Product\Lists\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'product/lists/type' );
	...
	public function testSave()
	{
		...
		$param = array(
			'type' => 'unittest',
			'item' => array(
				'product.lists.type.id' => '',
				'product.lists.type.status' => '1',
				'product.lists.type.domain' => 'product',
				'product.lists.type.code' => 'jqadm@test',
				'product.lists.type.label' => 'jqadm test',
			),
		);
	...
	public function testSearch()
	{
		$param = array(
			...
			'filter' => array(
				'key' => array( 0 => 'product.lists.type.code' ),
				'op' => array( 0 => '==' ),
				'val' => array( 0 => 'default' ),
			),
			'sort' => array( '-product.lists.type.id' ),
		);
		$helper = new \Aimeos\MW\View\Helper\Param\Standard( $this->view, $param );
		$this->view->addHelper( 'param', $helper );
