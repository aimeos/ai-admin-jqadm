...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Product\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Product\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'product/type' );
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Type\Product\Standard( $this->context, [] );
	...
	public function testSave()
	{
		...
		$param = array(
			...
			'item' => array(
				...
				'product.type.code' => 'jqadm@test',
				'product.type.label' => 'jqadm test',
			),
		);
	...
	public function testSearch()
	{
		$param = array(
			...
			'filter' => array(
				'key' => array( 0 => 'product.type.code' ),
				'op' => array( 0 => '==' ),
				'val' => array( 0 => 'default' ),
			),
			'sort' => array( '-product.type.id' ),
		);
		$helper = new \Aimeos\MW\View\Helper\Param\Standard( $this->view, $param );
		$this->view->addHelper( 'param', $helper );
