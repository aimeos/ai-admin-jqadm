...
class FactoryTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testCreateClientNameEmpty()
	{
		...
		\Aimeos\Admin\JQAdm\Type\Media\Lists\Factory::createClient( $this->context, '' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Media\Lists\Factory::createClient( $this->context, '%type/media/lists' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Media\Lists\Factory::createClient( $this->context, 'test' );
	}
