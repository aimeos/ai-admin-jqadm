...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Media\Lists\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Media\Lists\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'media/lists/type' );
	...
	public function testSave()
	{
		...
		$param = array(
			...
			'item' => array(
				...
				'media.lists.type.domain' => 'product',
				'media.lists.type.code' => 'jqadm@test',
				'media.lists.type.label' => 'jqadm test',
			),
		);
