...
class FactoryTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testCreateClientNameEmpty()
	{
		...
		\Aimeos\Admin\JQAdm\Type\Plugin\Factory::createClient( $this->context, '' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Plugin\Factory::createClient( $this->context, '%type/plugin' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Plugin\Factory::createClient( $this->context, 'test' );
	}
