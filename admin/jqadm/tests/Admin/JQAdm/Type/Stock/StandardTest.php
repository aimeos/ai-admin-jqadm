...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Stock\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Stock\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'stock/type' );
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Type\Stock\Standard( $this->context, [] );
