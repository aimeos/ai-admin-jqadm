...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Text\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Text\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'text/type' );
