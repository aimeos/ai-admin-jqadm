...
class FactoryTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testCreateClientNameEmpty()
	{
		...
		\Aimeos\Admin\JQAdm\Type\Price\Lists\Factory::createClient( $this->context, '' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Price\Lists\Factory::createClient( $this->context, '%type/price/lists' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Price\Lists\Factory::createClient( $this->context, 'test' );
	}
