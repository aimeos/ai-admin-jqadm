...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Price\Lists\Standard( $this->context );
	...
	public function testCreate()
	{
		...
		$this->assertStringContainsString( 'price/lists', $result );
	...
	{
		$manager = \Aimeos\MShop::create( $this->context, 'price/lists/type' );
	...
	{
		$object = new \Aimeos\Admin\JQAdm\Type\Price\Lists\Standard( $this->context, [] );
	...
	public function testSave()
	{
		...
		$param = array(
			...
			'item' => array(
				...
				'price.lists.type.domain' => 'product',
				'price.lists.type.code' => 'jqadm@test',
				'price.lists.type.label' => 'jqadm test',
			),
		);
	...
	public function testSearch()
	{
		$param = array(
			...
			'filter' => array(
				'key' => array( 0 => 'price.lists.type.code' ),
				'op' => array( 0 => '==' ),
				'val' => array( 0 => 'default' ),
			),
			'sort' => array( '-price.lists.type.id' ),
		);
		$helper = new \Aimeos\MW\View\Helper\Param\Standard( $this->view, $param );
		$this->view->addHelper( 'param', $helper );
