...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Type\Price\Lists\Standard( $this->context, $templatePaths );
	...
	{
		$object = $this->getMockBuilder( '\Aimeos\Admin\JQAdm\Type\Price\Lists\Standard' )
	...
	{
		$manager = \Aimeos\MShop\Factory::createManager( $this->context, 'price/lists/type' );
