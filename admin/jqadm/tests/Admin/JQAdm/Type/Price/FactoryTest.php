...
class FactoryTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testCreateClientNameEmpty()
	{
		...
		\Aimeos\Admin\JQAdm\Type\Price\Factory::createClient( $this->context, '' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Price\Factory::createClient( $this->context, '%type/price' );
	}
	...
	{
		$this->setExpectedException( '\\Aimeos\\Admin\\JQAdm\\Exception' );
		\Aimeos\Admin\JQAdm\Type\Price\Factory::createClient( $this->context, 'test' );
	}
