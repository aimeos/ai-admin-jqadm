...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\Admin\JQAdm\Dashboard\Order\Salesweekday\Standard( $this->context, $templatePaths );
	...
	public function testSearch()
	{
		...
		$this->assertContains( '<div class="order-salesweekday', $result );
	}
