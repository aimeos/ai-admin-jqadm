	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/catalog/standard/subparts';
	 ...
	 * @category Developer
	 */
	private $subPartNames = ['image', 'text', 'product'];
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'catalog' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'catalog', $view->item->getId() );
			return;
		}
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'catalog/item-default.php';
