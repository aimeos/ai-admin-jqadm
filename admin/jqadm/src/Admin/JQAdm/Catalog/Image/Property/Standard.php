...
{
	/** admin/jqadm/catalog/image/property/name
	 * Name of the property subpart used by the JQAdm catalog image implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Catalog\Image\Property\Myname".
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 *
		 *  admin/jqadm/catalog/image/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/catalog/image/property/decorators/local
		 */

		/** admin/jqadm/catalog/image/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/catalog/image/property/decorators/global = array( 'decorator1' )
		 *
		...
		/** admin/jqadm/catalog/image/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/catalog/image/property/decorators/local = array( 'decorator2' )
		 *
	...
	{
		/** admin/jqadm/catalog/image/property/standard/subparts
		 * List of JQAdm sub-clients rendered within the catalog image property section
		 *
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'catalog/item-image-property-standard.php';
