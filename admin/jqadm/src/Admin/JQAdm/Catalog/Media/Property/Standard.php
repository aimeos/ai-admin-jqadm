...
{
	/** admin/jqadm/catalog/media/property/name
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/catalog/media/property/decorators/local
		 */
	...
	{
		/** admin/jqadm/catalog/media/property/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/catalog/media/property/subparts', [] );
	}
	 ...
	 */
	protected function toArray( \Aimeos\MShop\Catalog\Item\Iface $item, array $data, bool $copy = false ) : array
	{
		$idx = 0;
		$siteId = $this->getContext()->getLocale()->getSiteId();
