	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/catalog/text/standard/subparts';
	...
	public function save()
	{
		...
		{
			$error = array( 'catalog-item-text' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
	...
	{
		/** admin/jqadm/catalog/text/standard/types
		 * List of text types that are managed by the catalog text subpart
		 *
		 * To extend or reduce the text types that can be managed by the catalog
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/catalog/text/standard/types', $this->typelist );
	}
	...
	protected function toArray( \Aimeos\MShop\Catalog\Item\Iface $item, $copy = false )
	{
		...
		foreach( $item->getListItems( 'text', 'default' ) as $listItem )
		{
			...
			if( in_array( $type, $this->getTypes() ) )
			{
				...
				$map[$langid]['catalog.lists.id'][$type] = $listItem->getId();
			}
		}
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'catalog/item-text-default.php';
