	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function copy() : ?string
	{
		...
		{
			$error = array( 'order-item' => $this->getContext()->getI18n()->dt( 'admin', 'Error retrieving data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function save() : ?string
	{
		...
		{
			$error = array( 'order-item' => $this->getContext()->getI18n()->dt( 'admin', 'Error saving data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
