...
/**
 * Factory for customer lists type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a customer lists type client object
	 *
	...
	public static function createClient( \Aimeos\MShop\Context\Item\Iface $context, array $templatePaths, $name = null )
	{
		...
		return self::addClientDecorators( $context, $client, $templatePaths, 'type/customer/lists' );
	}
