	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function copy()
	{
		...
		try
		{
			...
			$manager = \Aimeos\MShop::create( $context, 'customer/property/type' );
	...
	public function create()
	{
		...
		try
		{
			...
			if( !isset( $view->item ) ) {
				$view->item = \Aimeos\MShop::create( $context, 'customer/property/type' )->createItem();
			}
	...
	public function delete()
	{
		...
		try
		{
			...
			$search->setConditions( $search->compare( '==', 'customer.property.type.id', $ids ) );
