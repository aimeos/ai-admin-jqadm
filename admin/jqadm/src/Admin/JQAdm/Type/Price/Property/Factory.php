...
{
	/**
	 * Creates a price property type client object
	 *
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/price/property/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Price\\Property\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/price/property' );
	}
