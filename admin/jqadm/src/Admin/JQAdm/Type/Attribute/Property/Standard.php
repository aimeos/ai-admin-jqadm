	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function copy()
	{
		...
		try
		{
			...
			$manager = \Aimeos\MShop\Factory::createManager( $context, 'attribute/property/type' );
		...
		{
			$error = array( 'type-attribute-property-item' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
		catch( \Exception $e )
		{
			$error = array( 'type-attribute-property-item' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function create()
	{
		...
		try
		{
			...
			if( !isset( $view->item ) ) {
				$view->item = \Aimeos\MShop\Factory::createManager( $context, 'attribute/property/type' )->createItem();
			}

			$data['attribute.property.type.siteid'] = $view->item->getSiteId();
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'type/attribute/property', null, 'delete' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'type/attribute/property', $view->item->getId(), 'save' );
			return;
		}
	...
	public function search()
	{
		...
		{
			$total = 0;
			$params = $this->storeSearchParams( $view->param(), 'type/attribute/property' );
			$manager = \Aimeos\MShop\Factory::createManager( $context, 'attribute/property/type' );
		...
		$default = 'type/attribute/property/list-standard.php';
	...
	public function getSubClient( $propertytype, $name = null )
	{
		 ...
		 * @see admin/jqadm/type/attribute/property/decorators/global
		 */
		return $this->createSubClient( 'type/attribute/property' . $propertytype, $name );
	}
	...
	{
		/** admin/jqadm/type/attribute/property/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/type/attribute/property/standard/subparts', [] );
	}
	...
	protected function fromArray( array $data )
	{
		...
		if( isset( $data['attribute.property.type.id'] ) && $data['attribute.property.type.id'] != '' ) {
			$item = $manager->getItem( $data['attribute.property.type.id'] );
		} else {
	...
	protected function toArray( \Aimeos\MShop\Common\Item\Type\Iface $item, $copy = false )
	{
		...
		if( $copy === true )
		{
			$data['attribute.property.type.code'] = $data['attribute.property.type.code'] . '_copy';
			$data['attribute.property.type.id'] = '';
		}
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'type/attribute/property/item-standard.php';
