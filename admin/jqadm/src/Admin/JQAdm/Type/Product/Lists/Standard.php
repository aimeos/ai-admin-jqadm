	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function create()
	{
		...
		try
		{
			...
			$data['product.lists.type.siteid'] = $context->getLocale()->getSiteId();
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'type/product/lists' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'type/product/lists', $view->item->getId() );
			return;
		}
