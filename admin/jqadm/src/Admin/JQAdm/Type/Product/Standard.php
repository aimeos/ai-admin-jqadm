...
/**
 * Default implementation of type product JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		return $this->createBase( 'product' );
	}
	...
	{
		return $this->deleteBase( 'product' );
	}
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/type/product/decorators/local
		 */
	...
	{
		/** admin/jqadm/type/product/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/type/product/subparts', [] );
	}
