	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/type/product/standard/subparts';
	...
	public function create()
	{
		...
		try
		{
			...
			$data['product.type.siteid'] = $context->getLocale()->getSiteId();
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'type/product' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'type/product', $view->item->getId() );
			return;
		}
	...
	public function search()
	{
		...
		$default = 'type/product/list-default.php';
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'type/product/item-default.php';
