	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/type/product/property/standard/subparts';
	...
	public function create()
	{
		...
		try
		{
			...
			$data['product.property.type.siteid'] = $context->getLocale()->getSiteId();
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'type/product/property' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'type/product/property', $view->item->getId() );
			return;
		}
	...
	public function search()
	{
		...
		$default = 'type/product/property/list-default.php';
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'type/product/property/item-default.php';
