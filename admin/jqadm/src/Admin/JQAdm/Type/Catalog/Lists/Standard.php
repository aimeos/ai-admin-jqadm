...
sprintf( 'type/catalog/lists' ); // for translation


/**
 * Default implementation of catalog list type JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function copy()
	{
		...
		{
			$error = array( 'type-catalog-lists-item' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
		catch( \Exception $e )
		{
			$error = array( 'type-catalog-lists-item' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function create()
	{
		...
		try
		{
			...
			if( !isset( $view->item ) ) {
				$view->item = \Aimeos\MShop\Factory::createManager( $context, 'catalog/lists/type' )->createItem();
			}

			$data['catalog.lists.type.siteid'] = $view->item->getSiteId();
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'type/catalog/lists', null, 'delete' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'type/catalog/lists', $view->item->getId(), 'save' );
			return;
		}
	...
	public function search()
	{
		...
		{
			$total = 0;
			$params = $this->storeSearchParams( $view->param(), 'type/catalog/lists' );
			$manager = \Aimeos\MShop\Factory::createManager( $context, 'catalog/lists/type' );
		...
		/** admin/jqadm/type/catalog/lists/template-list
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/type/catalog/lists/template-list';
		$default = 'type/catalog/lists/list-standard.php';
	...
	public function getSubClient( $liststype, $name = null )
	{
		 ...
		 * @see admin/jqadm/type/catalog/lists/decorators/global
		 * @see admin/jqadm/type/catalog/lists/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/type/catalog/lists/decorators/excludes
		 * @see admin/jqadm/type/catalog/lists/decorators/local
		 */
		 ...
		 * @see admin/jqadm/type/catalog/lists/decorators/global
		 */
		return $this->createSubClient( 'type/catalog/lists' . $liststype, $name );
	}
	...
	{
		/** admin/jqadm/type/catalog/lists/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/type/catalog/lists/standard/subparts', [] );
	}
	...
	protected function fromArray( array $data )
	{
		...
		if( isset( $data['catalog.lists.type.id'] ) && $data['catalog.lists.type.id'] != '' ) {
			$item = $manager->getItem( $data['catalog.lists.type.id'] );
		} else {
	...
	protected function toArray( \Aimeos\MShop\Common\Item\Type\Iface $item, $copy = false )
	{
		...
		if( $copy === true )
		{
			$data['catalog.lists.type.code'] = $data['catalog.lists.type.code'] . '_copy';
			$data['catalog.lists.type.id'] = '';
		}
	...
	{
		/** admin/jqadm/type/catalog/lists/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/type/catalog/lists/template-item';
		$default = 'type/catalog/lists/item-standard.php';
