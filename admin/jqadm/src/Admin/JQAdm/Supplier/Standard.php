	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/supplier/standard/subparts';
	...
	public function create()
	{
		...
		try
		{
			...
			$data['supplier.id'] = $view->item->getId();
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'supplier' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'supplier', $view->item->getId() );
			return;
		}
	...
	public function search()
	{
		...
		$default = 'supplier/list-default.php';
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'supplier/item-default.php';
