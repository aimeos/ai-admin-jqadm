...
{
	/** admin/jqadm/supplier/image/property/name
	 * Name of the property subpart used by the JQAdm supplier image implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Supplier\Image\Property\Myname".
	...
	public function save()
	{
		...
		{
			$error = array( 'supplier-item-image-property' => $this->getContext()->getI18n()->dt( 'mshop', $e->getMessage() ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
		}
		catch( \Exception $e )
		{
			$error = array( 'supplier-item-image-property' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
			$view->errors = $view->get( 'errors', [] ) + $error;
		}
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 *
		 *  admin/jqadm/supplier/image/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/supplier/image/property/decorators/local
		 */

		/** admin/jqadm/supplier/image/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/supplier/image/property/decorators/global = array( 'decorator1' )
		 *
		...
		/** admin/jqadm/supplier/image/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/supplier/image/property/decorators/local = array( 'decorator2' )
		 *
	...
	{
		/** admin/jqadm/supplier/image/property/standard/subparts
		 * List of JQAdm sub-clients rendered within the supplier image property section
		 *
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'supplier/item-image-property-standard.php';
