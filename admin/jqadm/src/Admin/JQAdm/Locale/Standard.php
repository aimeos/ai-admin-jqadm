	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/locale/standard/subparts';
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'locale' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'locale', $view->item->getId() );
			return;
		}
	...
	public function search()
	{
		...
		$default = 'locale/list-default.php';
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'locale/item-default.php';
