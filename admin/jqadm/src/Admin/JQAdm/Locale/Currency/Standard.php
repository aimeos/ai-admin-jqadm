...
/**
 * Default implementation of locale currency JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function copy() : ?string
	{
		...
		{
			$error = array( 'locale-currency-item' => $this->getContext()->getI18n()->dt( 'admin', 'Error retrieving data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function delete() : ?string
	{
		...
		{
			$error = array( 'locale-currency-item' => $this->getContext()->getI18n()->dt( 'admin', 'Error deleting data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function save() : ?string
	{
		...
		{
			$error = array( 'locale-currency-item' => $this->getContext()->getI18n()->dt( 'admin', 'Error saving data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	{
		/** admin/jqadm/locale/currency/standard/subparts
	 ...
	 * @return \Aimeos\MShop\Locale\Item\Currency\Iface New locale item object
	 */
	protected function fromArray( array $data ) : \Aimeos\MShop\Locale\Item\Currency\Iface
	{
