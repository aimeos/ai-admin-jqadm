...
{
	/** admin/jqadm/dashboard/order/deliverytype/standard/subparts
	 * List of JQAdm sub-clients rendered within the dashboard deliverytype section
	 *
	...
	public function search()
	{
		 ...
		 * Relative path to the HTML body template of the order per deliverytype subpart for the dashboard.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/dashboard/order/deliverytype/template-item';
		$default = 'dashboard/item-order-deliverytype-default.php';
	...
	{
		/** admin/jqadm/dashboard/order/deliverytype/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/dashboard/order/deliverytype/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/dashboard/order/deliverytype/decorators/global
		 * @see admin/jqadm/dashboard/order/deliverytype/decorators/local
		 */

		/** admin/jqadm/dashboard/order/deliverytype/decorators/global
		 ...
		 *
		 *  admin/jqadm/dashboard/order/deliverytype/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/dashboard/order/deliverytype/decorators/excludes
		 * @see admin/jqadm/dashboard/order/deliverytype/decorators/local
		 */

		/** admin/jqadm/dashboard/order/deliverytype/decorators/local
		 ...
		 *
		 *  admin/jqadm/dashboard/order/deliverytype/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/dashboard/order/deliverytype/decorators/global
		 */
		return $this->createSubClient( 'dashboard/order/deliverytype/' . $type, $name );
	}
