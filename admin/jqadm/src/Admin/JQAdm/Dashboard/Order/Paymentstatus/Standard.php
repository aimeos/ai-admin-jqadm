...
{
	/** admin/jqadm/dashboard/order/paymentstatus/standard/subparts
	 * List of JQAdm sub-clients rendered within the dashboard paymentstatus section
	 *
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/dashboard/order/paymentstatus/standard/subparts';
	...
	public function search()
	{
		...
		{
			$error = array( 'order-paymentstatus' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
			$view->errors = $view->get( 'errors', [] ) + $error;
		}

		/** admin/jqadm/dashboard/order/paymentstatus/template-item
		 * Relative path to the HTML body template of the order per paymentstatus subpart for the dashboard.
		 *
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 *
		 *  admin/jqadm/dashboard/order/paymentstatus/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/dashboard/order/paymentstatus/decorators/local
		 */

		/** admin/jqadm/dashboard/order/paymentstatus/decorators/global
		 ...
		 *
		 *  admin/jqadm/dashboard/order/paymentstatus/decorators/global = array( 'decorator1' )
		 *
		...
		/** admin/jqadm/dashboard/order/paymentstatus/decorators/local
		 ...
		 *
		 *  admin/jqadm/dashboard/order/paymentstatus/decorators/local = array( 'decorator2' )
		 *
