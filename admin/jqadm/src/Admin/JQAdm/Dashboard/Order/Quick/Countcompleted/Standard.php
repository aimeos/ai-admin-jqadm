...
namespace Aimeos\Admin\JQAdm\Dashboard\Order\Quick\Countcompleted;

sprintf( 'quick/countcompleted' ); // for translation


/**
 * Default implementation of dashboard quick/countcompleted JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/dashboard/order/quick/countcompleted/name
	...
	public function search() : ?string
	{
		...
		/** admin/jqadm/dashboard/order/quick/countcompleted/template-item
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/quick/countcompleted/decorators/global
		 * @see admin/jqadm/dashboard/order/quick/countcompleted/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/dashboard/order/quick/countcompleted/decorators/excludes
		 * @see admin/jqadm/dashboard/order/quick/countcompleted/decorators/local
		 */
		 ...
		 * @see admin/jqadm/dashboard/order/quick/countcompleted/decorators/global
		 */
		return $this->createSubClient( 'dashboard/order/quick/countcompleted/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/dashboard/order/quick/countcompleted/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/dashboard/order/quick/countcompleted/subparts', [] );
	}
}
