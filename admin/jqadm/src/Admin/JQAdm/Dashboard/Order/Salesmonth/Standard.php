...
/**
 * Default implementation of dashboard salesmonth JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		/** admin/jqadm/dashboard/order/salesmonth/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/dashboard/order/salesmonth/subparts', [] );
	}
}
