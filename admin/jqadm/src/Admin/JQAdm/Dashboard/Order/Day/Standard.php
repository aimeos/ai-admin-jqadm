...
/**
 * Default implementation of dashboard day JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/dashboard/order/day/standard/subparts
	 * List of JQAdm sub-clients rendered within the dashboard day section
	 *
	...
	public function search()
	{
		 ...
		 * Relative path to the HTML body template of the order per day subpart for the dashboard.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/dashboard/order/day/template-item';
		$default = 'dashboard/item-order-day-default.php';
	...
	{
		/** admin/jqadm/dashboard/order/day/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/dashboard/order/day/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/dashboard/order/day/decorators/global
		 * @see admin/jqadm/dashboard/order/day/decorators/local
		 */

		/** admin/jqadm/dashboard/order/day/decorators/global
		 ...
		 *
		 *  admin/jqadm/dashboard/order/day/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/dashboard/order/day/decorators/excludes
		 * @see admin/jqadm/dashboard/order/day/decorators/local
		 */

		/** admin/jqadm/dashboard/order/day/decorators/local
		 ...
		 *
		 *  admin/jqadm/dashboard/order/day/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/dashboard/order/day/decorators/global
		 */
		return $this->createSubClient( 'dashboard/order/day/' . $type, $name );
	}
