...
/**
 * Default implementation of dashboard servicepayment JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function search() : ?string
	{
		...
		{
			$error = array( 'order-servicepayment' => $this->getContext()->getI18n()->dt( 'admin', 'Error retrieving data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/servicepayment/decorators/local
		 */
	...
	{
		/** admin/jqadm/dashboard/order/servicepayment/standard/subparts
