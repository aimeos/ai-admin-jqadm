...
/**
 * Default implementation of dashboard countday JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function search() : ?string
	{
		...
		{
			$error = array( 'order-countday' => $this->getContext()->getI18n()->dt( 'admin', 'Error saving data' ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/countday/decorators/local
		 */
	...
	{
		/** admin/jqadm/dashboard/order/countday/standard/subparts
