...
/**
 * Default implementation of dashboard countpaystatus JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/countpaystatus/decorators/local
		 */
	...
	{
		/** admin/jqadm/dashboard/order/countpaystatus/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/dashboard/order/countpaystatus/subparts', [] );
	}
}
