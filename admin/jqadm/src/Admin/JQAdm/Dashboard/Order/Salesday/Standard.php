...
namespace Aimeos\Admin\JQAdm\Dashboard\Order\Salesday;


/**
 * Default implementation of dashboard salesday JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/salesday/decorators/local
		 */
	...
	{
		/** admin/jqadm/dashboard/order/salesday/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/dashboard/order/salesday/subparts', [] );
	}
}
