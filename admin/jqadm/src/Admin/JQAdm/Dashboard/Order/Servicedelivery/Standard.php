...
/**
 * Default implementation of dashboard servicedelivery JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		$view = $this->view();
		$view->orderservicedeliveryBody = parent::search();
	...
	public function getSubClient( string $type, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 * @see admin/jqadm/dashboard/order/servicedelivery/decorators/local
		 */
	...
	{
		/** admin/jqadm/dashboard/order/servicedelivery/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/dashboard/order/servicedelivery/subparts', [] );
	}
}
