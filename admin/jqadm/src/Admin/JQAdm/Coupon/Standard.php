	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/coupon/standard/subparts';
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'coupon' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'coupon', $view->item->getId() );
			return;
		}
	...
	public function search()
	{
		...
		$default = 'coupon/list-default.php';
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'coupon/item-default.php';
