	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/plugin/standard/subparts';
	...
	public function delete()
	{
		...
		try
		{
			...
			$this->nextAction( $view, 'search', 'plugin' );
			return;
		}
		catch( \Aimeos\MShop\Exception $e )
		{
	...
	public function save()
	{
		...
		try
		{
			...
			$this->nextAction( $view, $view->param( 'next' ), 'plugin', $view->item->getId() );
			return;
		}
	...
	public function search()
	{
		...
		$default = 'plugin/list-default.php';
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'plugin/item-default.php';
