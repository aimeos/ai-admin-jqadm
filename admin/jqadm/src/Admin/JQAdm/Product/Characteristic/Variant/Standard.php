...
namespace Aimeos\Admin\JQAdm\Product\Characteristic\Variant;


/**
 * Default implementation of product variant JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/product/characteristic/variant/name
	...
	public function create()
	{
		...
		$data = array_replace_recursive( $this->toArray( $view->item ), $view->param( 'characteristic/variant', [] ) );
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see admin/jqadm/product/characteristic/variant/decorators/global
		 * @see admin/jqadm/product/characteristic/variant/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/product/characteristic/variant/decorators/excludes
		 * @see admin/jqadm/product/characteristic/variant/decorators/local
		 */
		 ...
		 * @see admin/jqadm/product/characteristic/variant/decorators/global
		 */
		return $this->createSubClient( 'product/characteristic/variant/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/product/characteristic/variant/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/characteristic/variant/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Product\Item\Iface $item, array $data )
	{
		...
		$listTypeId = $typeManager->findItem( 'variant', [], 'attribute' )->getId();
	...
	{
		/** admin/jqadm/product/characteristic/variant/template-item
