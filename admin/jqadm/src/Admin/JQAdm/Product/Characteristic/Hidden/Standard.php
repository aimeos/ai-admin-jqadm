...
/**
 * Default implementation of product hidden JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function create()
	{
		...
		$data = array_replace_recursive( $this->toArray( $view->item ), $view->param( 'characteristic/hidden', [] ) );
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see admin/jqadm/product/characteristic/hidden/decorators/global
		 * @see admin/jqadm/product/characteristic/hidden/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/product/characteristic/hidden/decorators/excludes
		 * @see admin/jqadm/product/characteristic/hidden/decorators/local
		 */
		 ...
		 * @see admin/jqadm/product/characteristic/hidden/decorators/global
		 */
		return $this->createSubClient( 'product/characteristic/hidden/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/product/characteristic/hidden/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/characteristic/hidden/standard/subparts', [] );
	}
	...
	{
		/** admin/jqadm/product/characteristic/hidden/template-item
