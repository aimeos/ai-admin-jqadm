	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		/** admin/jqadm/product/characteristic/hidden/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/characteristic/hidden/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Product\Item\Iface $item, array $data ) : \Aimeos\MShop\Product\Item\Iface
	{
		...
		foreach( $data as $idx => $entry )
		{
			...
			$litem = $listItems->pull( $id ) ?: $listManager->create()->setType( 'hidden' );
