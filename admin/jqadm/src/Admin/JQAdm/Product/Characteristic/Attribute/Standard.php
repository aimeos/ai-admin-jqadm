	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function create()
	{
		...
		$data = array_replace_recursive( $this->toArray( $view->item ), $view->param( 'characteristic/attribute', [] ) );
	...
	protected function getSubClientNames()
	{
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/characteristic/attribute/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Product\Item\Iface $item, array $data )
	{
		...
		$listTypeId = $typeManager->findItem( 'default', [], 'attribute' )->getId();
