...
namespace Aimeos\Admin\JQAdm\Product\Related\Suggest;


/**
 * Default implementation of product suggest JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/product/related/bought/name
	...
	public function create()
	{
		...
		foreach( $this->getSubClients() as $client ) {
			$view->suggestBody .= $client->create();
		}
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see admin/jqadm/product/related/suggest/decorators/global
		 * @see admin/jqadm/product/related/suggest/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/product/related/suggest/decorators/excludes
		 * @see admin/jqadm/product/related/suggest/decorators/local
		 */
		 ...
		 * @see admin/jqadm/product/related/suggest/decorators/global
		 */
		return $this->createSubClient( 'product/related/suggest/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/product/related/suggest/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/related/suggest/standard/subparts', [] );
	}
	 ...
	 * @return array Associative list of suggested product IDs as keys and list items as values
	 */
	...
	protected function fromArray( \Aimeos\MShop\Product\Item\Iface $item, array $data )
	{
		...
		$litem->setTypeId( $typeManager->findItem( 'suggestion', [], 'product' )->getId() );
	...
	{
		/** admin/jqadm/product/related/suggest/template-item
		...
		$default = 'product/item-related-suggest-standard.php';
