	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function create()
	{
		...
		$data = array_replace_recursive( $this->toArray( $view->item ), $view->param( 'related/bought', [] ) );
	...
	{
		/** admin/jqadm/product/related/bought/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/related/bought/standard/subparts', [] );
	}
