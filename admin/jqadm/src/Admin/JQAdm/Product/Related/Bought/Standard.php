	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/product/related/bought/standard/subparts';
	...
	public function create()
	{
		...
		$view->boughtData = $view->param( 'related/bought', [] );
		$view->boughtBody = '';
	...
	public function save()
	{
		...
		{
			$error = array( 'product-item-related-bought' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
		}
		catch( \Exception $e )
		{
			$error = array( 'product-item-related-bought' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
			$view->errors = $view->get( 'errors', [] ) + $error;
		}
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		...
		$default = 'product/item-related-bought-default.php';
