...
/**
 * Default implementation of product custom JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function create()
	{
		...
		$data = array_replace_recursive( $this->toArray( $view->item ), $view->param( 'option/custom', [] ) );
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see admin/jqadm/product/option/custom/decorators/global
		 * @see admin/jqadm/product/option/custom/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/product/option/custom/decorators/excludes
		 * @see admin/jqadm/product/option/custom/decorators/local
		 */
		 ...
		 * @see admin/jqadm/product/option/custom/decorators/global
		 */
		return $this->createSubClient( 'product/option/custom/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/product/option/custom/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/option/custom/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Product\Item\Iface $item, array $data )
	{
		...
		$listTypeId = $typeManager->findItem( 'custom', [], 'attribute' )->getId();
	...
	{
		/** admin/jqadm/product/option/custom/template-item
