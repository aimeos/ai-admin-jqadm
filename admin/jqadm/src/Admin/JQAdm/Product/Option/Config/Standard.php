	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	{
		/** admin/jqadm/product/option/config/exclude
		 ...
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/option/config/exclude', [] );
	}
	...
	{
		/** admin/jqadm/product/option/config/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/option/config/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Product\Item\Iface $item, array $data ) : \Aimeos\MShop\Product\Item\Iface
	{
		...
		foreach( $data as $idx => $entry )
		{
			...
			$litem = $listItems->pull( $id ) ?: $listManager->create()->setType( 'config' );
