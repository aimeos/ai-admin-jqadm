	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function copy()
	{
		...
		$view->specialpriceData = $this->toArray( $view->item, true );
	...
	public function get()
	{
		...
		$view->specialpriceData = $this->toArray( $view->item );
		$view->specialpriceBody = '';
	...
	protected function getSubClientNames()
	{
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/product/special/price/standard/subparts', [] );
	}
