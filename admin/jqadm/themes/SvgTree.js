...
$(function() {
    ...
    SvgTree.prototype = {
         ...
         * @param {Array|Function|string} data
         */
        initialize: function (selector, settings, data) {
            ...
            if(Array.isArray(data)) {
                ...
                data(this.addNodes.bind(this));
            } else if(typeof data === "string") {
                this.loadData(data);
            } else if(typeof this.settings.dataUrl === "string") {
                this.loadData(this.settings.dataUrl);
            } else {
                throw "Tree data isn't a path, function or array";
            }
        ...
        addNodes: function(nodes) {
            ...
            this.nodes = nodes;
            this.dispatch.call('loadDataAfter', me);
        ...
        loadData: function () {
            ...
            d3.json(this.settings.dataUrl, function (error, json) {
                ...
                this.addNodes(Array.isArray(json) ? json : []);
            });
        },
