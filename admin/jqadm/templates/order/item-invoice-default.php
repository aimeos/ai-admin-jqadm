				...
				<?php foreach( $this->get( 'invoiceData/order.id', [] ) as $idx => $orderId ) : ?>
					<tr>
						...
						<td class="order-datepayment">
							<input class="form-control item-datedelivery" type="datetime-local" tabindex="<?= $this->get( "tabindex" ); ?>"
						...
						<td class="order-datedelivery">
							<input class="form-control item-datedelivery" type="date" tabindex="<?= $this->get( "tabindex" ); ?>"
						...
						<td class="order-statusdelivery">
							<select class="form-control c-select product-status" required="required" tabindex="<?= $this->get( "tabindex" ); ?>"
						...
						<td class="order-relatedid">
							<input class="form-control item-relatedid" type="text" tabindex="<?= $this->get( "tabindex" ); ?>"
