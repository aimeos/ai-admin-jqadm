...
<form class="item item-service-lists-type form-horizontal container-fluid" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ) ?>">
		...
		<div class="col-xl-9 item-content tab-content">
			...
			<div id="basic" class="row item-basic tab-pane fade show active" role="tabpanel" aria-labelledby="basic">
				...
				<div class="col">
					<div class="box">
						<div class="row">
							<div class="col-xl-6 <?= $this->site()->readonly( $this->get( 'itemData/service.lists.type.siteid' ) ) ?>">
