...
<form class="item item-service-lists-type form-horizontal" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ); ?>">
	...
	<nav class="main-navbar">
		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Service Lists Type' ) ); ?>:
			<?= $enc->html( $this->get( 'itemData/service.lists.type.id' ) ); ?> -
			<?= $enc->html( $this->get( 'itemData/service.lists.type.label', $this->translate( 'admin', 'New' ) ) ); ?>
			<span class="navbar-secondary">(<?= $enc->html( $this->site()->match( $this->get( 'itemData/service.lists.type.siteid' ) ) ); ?>)</span>
		</span>
