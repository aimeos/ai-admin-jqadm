...
<nav class="main-navbar">
	...
	<span class="navbar-brand">
		<?= $enc->html( $this->translate( 'admin', 'Customer Types' ) ); ?>
...
<form class="list-customer-lists-type" method="POST" action="<?= $enc->attr( $this->url( $target, $controller, $action, $params, [], $config ) ); ?>">
	<?= $this->csrf()->formfield(); ?>
