...
<form class="item item-price-lists-type form-horizontal" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ); ?>">
	...
	<nav class="main-navbar">
		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Price Lists Type' ) ); ?>:
			<?= $enc->html( $this->get( 'itemData/price.lists.type.id' ) ); ?> -
			<?= $enc->html( $this->get( 'itemData/price.lists.type.label', $this->translate( 'admin', 'New' ) ) ); ?>
			<span class="navbar-secondary">(<?= $enc->html( $this->site()->match( $this->get( 'itemData/price.lists.type.siteid' ) ) ); ?>)</span>
		</span>
	...
	<div class="row item-container">
		...
		<div class="col-md-9 item-content tab-content">
			...
			<div id="basic" class="row item-basic tab-pane fade show active" role="tabpanel" aria-labelledby="basic">
				...
				<div class="col-xl-6 content-block <?= $this->site()->readonly( $this->get( 'itemData/price.lists.type.siteid' ) ); ?>">
