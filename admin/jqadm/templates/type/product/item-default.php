...
<form class="item item-product form-horizontal" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ); ?>">
	...
	<nav class="main-navbar">
		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Product Type' ) ); ?>:
			<?= $enc->html( $this->get( 'itemData/product.type.id' ) ); ?> -
			<?= $enc->html( $this->get( 'itemData/product.type.label', $this->translate( 'admin', 'New' ) ) ); ?>
			<span class="navbar-secondary">(<?= $enc->html( $this->site()->match( $this->get( 'itemData/product.type.siteid' ) ) ); ?>)</span>
		</span>
				...
				<div class="col-xl-6 content-block <?= $this->site()->readonly( $this->get( 'itemData/product.type.siteid' ) ); ?>">
					...
					<div class="form-group row mandatory">
						...
						<div class="col-sm-12 form-text text-muted help-text">
							<?= $enc->html( $this->translate( 'admin', 'Unique type code, e.g. "color" for products like "green", "blue", "red"' ) ); ?>
						</div>
					</div>
					<div class="form-group row mandatory">
