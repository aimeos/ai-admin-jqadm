...
<form class="item item-product-property-type form-horizontal" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ); ?>">
	...
	<nav class="main-navbar">
		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Product Property Type' ) ); ?>:
			<?= $enc->html( $this->get( 'itemData/product.property.type.id' ) ); ?> -
			<?= $enc->html( $this->get( 'itemData/product.property.type.label', $this->translate( 'admin', 'New' ) ) ); ?>
			<span class="navbar-secondary">(<?= $enc->html( $this->site()->match( $this->get( 'itemData/product.property.type.siteid' ) ) ); ?>)</span>
		</span>
