...
<div class="list-view"
	...
	data-filter="<?= $enc->attr( $this->session( 'aimeos/admin/jqadm/type/catalog/lists/filter', [] ) ) ?>"
	...
	<nav-search v-bind:show="search" v-on:close="search = false"
		...
		v-bind:filter="<?= $enc->attr( $this->session( 'aimeos/admin/jqadm/type/catalog/lists/filter', [] ) ) ?>"
