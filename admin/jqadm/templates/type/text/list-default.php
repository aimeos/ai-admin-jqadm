...
<nav class="main-navbar">
	...
	<?= $this->partial(
		$this->config( 'admin/jqadm/partial/navsearch', 'common/partials/navsearch-default.php' ), [
			...
			'filterTexts' => $this->get( 'filterTexts', [] ),
...
<form class="list-text" method="POST" action="<?= $enc->attr( $this->url( $target, $controller, $action, $params, [], $config ) ); ?>">
	<?= $this->csrf()->formfield(); ?>
			...
			<?= $this->partial(
				$this->config( 'admin/jqadm/partial/listsearch', 'common/partials/listsearch-default.php' ), [
					...
					'data' => [
						...
						'text.type.code' => [],
						'text.type.label' => [],
						'text.ctime' => ['op' => '>=', 'type' => 'datetime-local'],
						'text.mtime' => ['op' => '>=', 'type' => 'datetime-local'],
						'text.editor' => [],
					]
				] );
			?>
