...
<form class="item item-text form-horizontal" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ); ?>">
				...
				<div class="col-xl-6 content-block <?= $this->site()->readonly( $this->get( 'itemData/text.type.siteid' ) ); ?>">
					<div class="form-group row mandatory">
						...
						<div class="col-sm-8">
							<select class="form-control custom-select item-domain" required="required" tabindex="1"
								...
								<?php foreach( ['text', 'catalog', 'customer', 'media', 'price', 'product', 'service', 'supplier', 'text'] as $domain ) : ?>
					...
					<div class="form-group row mandatory">
						...
						<div class="col-sm-12 form-text text-muted help-text">
							<?= $enc->html( $this->translate( 'admin', 'Unique type code, e.g. "color" for texts like "green", "blue", "red"' ) ); ?>
						</div>
					</div>
					<div class="form-group row mandatory">
