...
<form class="list list-attribute-property-type" method="POST" action="<?= $enc->attr( $this->url( $target, $controller, $action, $params, [], $config ) ); ?>">
	<?= $this->csrf()->formfield(); ?>
	...
	<table class="list-items table table-hover table-striped">
		...
		<tbody>
			...
			<?= $this->partial(
				$this->config( 'admin/jqadm/partial/propertyearch', 'common/partials/listsearch-default.php' ), [
