...
<form class="item item-attribute-type form-horizontal container-fluid" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ) ?>">
	...
	<div class="row item-container">
		...
		<div class="col-xl-9 item-content tab-content">
			...
			<div id="basic" class="item-basic tab-pane fade show active" role="tabpanel" aria-labelledby="basic">
				...
				<div class="box">
					<div class="row">
						<div class="col-xl-6 <?= $this->site()->readonly( $this->get( 'itemData/attribute.type.siteid' ) ) ?>">
