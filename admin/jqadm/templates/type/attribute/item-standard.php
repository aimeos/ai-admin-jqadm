...
<form class="item item-attribute-type form-horizontal" method="POST" enctype="multipart/form-data" action="<?= $enc->attr( $this->url( $target, $cntl, $action, $params, [], $config ) ); ?>">
	...
	<nav class="main-navbar">
		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Attribute Type' ) ); ?>:
			<?= $enc->html( $this->get( 'itemData/attribute.type.id' ) ); ?> -
			<?= $enc->html( $this->get( 'itemData/attribute.type.label', $this->translate( 'admin', 'New' ) ) ); ?>
			<span class="navbar-secondary">(<?= $enc->html( $this->site()->match( $this->get( 'itemData/attribute.type.siteid' ) ) ); ?>)</span>
		</span>
