 ...
 * @category Developer
 */
$default = $this->config( 'admin/jqadm/product/fields', ['customer.code', 'customer.status', 'customer.firstname', 'customer.lastname', 'customer.postal', 'customer.city', 'customer.countryid'] );
				...
				<?php foreach( $this->get( 'items', [] ) as $id => $item ) : ?>
					...
					<tr class="<?= $this->site()->readonly( $item->getSiteId() ); ?>">
						...
						<?php if( in_array( 'customer.code', $fields ) ) : ?>
							<td class="customer-code"><a class="items-field" href="<?= $url; ?>"><?= $enc->html( $item->getCode() ); ?></a></td>
						<?php endif; ?>
