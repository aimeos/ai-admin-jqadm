...
<div class="dropdown filter-columns">
	<button class="btn act-columns fa" type="button" id="dropdownMenuButton-<?= $this->( 'group' ) ?>"
	...
	<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton-<?= $this->( 'group' ) ?>">
