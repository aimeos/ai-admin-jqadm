...
<div class="aimeos" lang="<?= $this->param( 'lang' ); ?>" data-url="<?= $enc->attr( $this->url( $jsonTarget, $jsonCntl, $jsonAction, array( 'site' => $site ), [], $jsonConfig ) ); ?>">
	...
	<nav class="main-sidebar">
		<div class="sidebar-wrapper">
			...
			<a class="logo" href="https://aimeos.org/update/?type=<?= $this->get( 'aimeosType' ) ?>&version=<?= $this->get( 'aimeosVersion' ) ?>">
			...
			<ul class="sidebar-menu basic">
				...
				<?php if( ( count( $this->get( 'pageSiteList', [] ) ) > 1 || $this->pageSiteTree->getChildren() !== [] ) && $this->access( $this->config( 'admin/jqadm/resource/site/groups', [] ) ) ) : ?>
