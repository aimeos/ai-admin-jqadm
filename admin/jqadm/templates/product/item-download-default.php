...
<div class="product-item-download card panel">
	<div id="product-item-download" class="header card-header" role="tab" data-toggle="collapse" data-parent="#accordion" data-target="#product-item-download-data" aria-expanded="true" aria-controls="product-item-download-data">
		<?= $enc->html( $this->translate( 'admin', 'Download' ) ); ?>
	</div>
	<div id="product-item-download-data" class="item-download card-block panel-collapse collapse table-responsive" role="tabpanel" aria-labelledby="product-item-download">
		<div class="col-lg-6">
			<div class="form-group row optional">
				<label class="col-sm-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'File' ) ); ?></label>
				<div class="col-sm-9">
			...
			<div class="form-group row optional">
				...
				<div class="col-sm-9">
					<select class="form-control c-select item-status" name="<?= $enc->attr( $this->formparam( array( 'download', 'product.lists.status' ) ) ); ?>">
						...
						<option value="-2" <?= $selected( $this->get( 'downloadData/product.lists.status', 1 ), -2 ); ?>><?= $enc->html( $this->translate( 'admin', 'status:archive' ) ); ?></option>
					</select>
				</div>
			</div>
			<div class="form-group row optional">
				<label class="col-sm-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Name' ) ); ?></label>
				<div class="col-sm-9">
			...
			<div class="form-group row optional">
				<label class="col-sm-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Replace file' ) ); ?></label>
				<div class="col-sm-9">
		...
		<div class="col-lg-6">
			<?php if( $this->get( 'downloadData/path' ) != '' ) : ?>
				<div class="form-group row">
					<label class="col-sm-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Path' ) ); ?></label>
					<div class="col-sm-9">
						<p class="form-control-static item-file"><?= $enc->html( $this->get( 'downloadData/path' ) ); ?></p>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Size' ) ); ?></label>
					<div class="col-sm-9">
						<p class="form-control-static item-file"><?= $enc->html( number_format( $this->get( 'downloadData/size' ) / 1024, 0, '.', ' ' ) ); ?> KB</p>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Uploaded' ) ); ?></label>
					<div class="col-sm-9">
