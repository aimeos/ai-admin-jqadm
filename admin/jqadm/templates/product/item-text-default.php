...
<div class="product-item-text card panel">
	<div id="product-item-text" class="header card-header collapsed" role="tab"
		...
		<?= $enc->html( $this->translate( 'admin', 'Texts' ) ); ?>
	</div>
		...
		<div id="product-item-text-group" role="tablist" aria-multiselectable="true">
			...
			<?php foreach( (array) $this->get( 'textData/langid', [] ) as $idx => $langid ) : ?>
				...
				<div class="group-item card panel">
					<div id="product-item-text-group-item-<?= $enc->attr( $idx ); ?>" class="card-header header collapsed" role="tab"
						data-toggle="collapse" data-target="#product-item-text-group-data-<?= $enc->attr( $idx ); ?>"
						aria-expanded="false" aria-controls="product-item-text-group-data-<?= $enc->attr( $idx ); ?>">
						<select class="combobox text-langid" name="<?= $enc->attr( $this->formparam( array( 'text', 'langid', '' ) ) ); ?>">
					...
					<div id="product-item-text-group-data-<?= $enc->attr( $idx ); ?>" class="card-block panel-collapse collapse"
						role="tabpanel" aria-labelledby="product-item-text-group-item-<?= $enc->attr( $idx ); ?>">
						<div class="col-lg-6">
							<div class="form-group row optional">
								<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Product name' ) ); ?></label>
								<div class="col-lg-9">
							...
							<div class="form-group row optional">
								<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Short description' ) ); ?></label>
								<div class="col-lg-9">
							...
							<div class="form-group row optional">
								<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Long description' ) ); ?></label>
								<div class="col-lg-9">
									...
									<textarea class="form-control htmleditor item-long-content" rows="6" name="<?= $enc->attr( $this->formparam( array( 'text', 'long', 'content', '' ) ) ); ?>"
						...
						<div class="col-lg-6">
							<div class="form-group row optional">
								<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'URL segment' ) ); ?></label>
								<div class="col-lg-9">
							...
							<div class="form-group row optional">
								<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Meta keywords' ) ); ?></label>
								<div class="col-lg-9">
							...
							<div class="form-group row optional">
								<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Meta description' ) ); ?></label>
								<div class="col-lg-9">
			...
			<div class="group-item card panel prototype">
				<div class="card-header header collapsed" role="tab" data-toggle="collapse" aria-expanded="false">
					<select class="combobox-prototype text-langid" name="<?= $enc->attr( $this->formparam( array( 'text', 'langid', '' ) ) ); ?>">
					</select>
					<div class="btn btn-secondary fa fa-plus"></div>
					<div class="btn btn-danger fa fa-trash"></div>
					...
					<div class="col-lg-6">
						<div class="form-group row optional">
							...
							<div class="col-lg-9">
								...
								<input class="form-control item-name-content" type="text" name="<?= $enc->attr( $this->formparam( array( 'text', 'name', 'content', '' ) ) ); ?>"
									placeholder="<?= $enc->attr( $this->translate( 'admin', 'Product name' ) ); ?>" value="" disabled="disabled" />
							</div>
						</div>
						<div class="form-group row optional">
							<label class="col-lg-3 form-control-label"><?= $enc->html( $this->translate( 'admin', 'Short description' ) ); ?></label>
