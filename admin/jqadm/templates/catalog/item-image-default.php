		...
		<?php foreach( $this->get( 'imageData/catalog.lists.id', [] ) as $idx => $id ) : ?>
			...
			<div class="group-item card <?= $this->site()->readonly( $this->get( 'imageData/catalog.lists.siteid/' . $idx ) ); ?>">
				...
				<div id="item-image-group-data-<?= $enc->attr( $idx ); ?>" class="card-block collapse row <?= ( $idx === 0 ? 'show' : '' ); ?>"
								...
								<div class="col-sm-8">
									<select class="form-control custom-select listitem-typeid" required="required" tabindex="<?= $this->get( 'tabindex' ); ?>"
										...
										<?php foreach( $this->get( 'imageListTypes', [] ) as $id => $typeItem ) : ?>
											<option value="<?= $enc->attr( $id ); ?>" <?= $selected( $this->get( 'imageData/catalog.lists.typeid/' . $idx ), $id ); ?> >
												<?= $enc->html( $typeItem->getLabel() ); ?>
											</option>
										<?php endforeach; ?>
									</select>
						...
						<div class="form-group row optional">
							...
							<div class="col-sm-8">
								<input class="form-control listitem-datestart" type="datetime-local" tabindex="<?= $this->get( 'tabindex' ); ?>"
									...
									value="<?= $enc->attr( str_replace( ' ', 'T', $this->get( 'imageData/catalog.lists.datestart/' . $idx ) ) ); ?>"
									<?= $this->site()->readonly( $this->get( 'imageData/catalog.lists.siteid/' . $idx ) ); ?> />
							</div>
							<div class="col-sm-12 form-text text-muted help-text">
						...
						<div class="form-group row optional">
							...
							<div class="col-sm-8">
								<input class="form-control listitem-dateend" type="datetime-local" tabindex="<?= $this->get( 'tabindex' ); ?>"
									...
									placeholder="<?= $enc->attr( $this->translate( 'admin', 'YYYY-MM-DD hh:mm:ss (optional)' ) ); ?>"
									value="<?= $enc->attr( str_replace( ' ', 'T', $this->get( 'imageData/catalog.lists.dateend/' . $idx ) ) ); ?>"
									<?= $this->site()->readonly( $this->get( 'imageData/catalog.lists.siteid/' . $idx ) ); ?> />
							</div>
							<div class="col-sm-12 form-text text-muted help-text">
					...
					<div class="col-xl-6 content-block secondary <?= $this->site()->readonly( $this->get( 'imageData/catalog.lists.siteid/' . $idx ) ); ?>">
