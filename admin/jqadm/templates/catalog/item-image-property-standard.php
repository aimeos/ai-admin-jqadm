...
?>
<div v-show="advanced[idx]" class="item-image-property col-xl-12 content-block secondary" v-bind:class="items['catalog.lists.siteid'][idx] != '<?= $this->site()->siteid() ?>' ? 'readonly' : ''">
