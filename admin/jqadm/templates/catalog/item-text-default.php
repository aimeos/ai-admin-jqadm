			...
			<div v-bind:id="'item-text-group-data-' + idx" v-bind:class="getCss(idx)"
				...
				<div class="col-xl-6">
					<div class="form-group row optional">
						<label class="col-sm-4 form-control-label help"><?= $enc->html( $this->translate( 'admin', 'Category name' ) ); ?></label>
						<div class="col-sm-8">
							<input class="item-name-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'name', 'catalog.lists.id', '' ) ) ); ?>"
								v-model="item['catalog.lists.id']['name']" />
							<input class="form-control item-name-content" type="text" tabindex="<?= $this->get( 'tabindex' ); ?>"
								...
								placeholder="<?= $enc->attr( $this->translate( 'admin', 'Category name' ) ); ?>"
								v-bind:readonly="checkSite('text.siteid', idx)"
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-short-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'short', 'catalog.lists.id', '' ) ) ); ?>"
								v-model="item['catalog.lists.id']['short']" />
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-long-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'long', 'catalog.lists.id', '' ) ) ); ?>"
								v-model="item['catalog.lists.id']['long']" />
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-url-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'url', 'catalog.lists.id', '' ) ) ); ?>"
								v-model="item['catalog.lists.id']['url']" />
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-meta-keyword-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'meta-keyword', 'catalog.lists.id', '' ) ) ); ?>"
								v-model="item['catalog.lists.id']['meta-keyword']" />
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-meta-description-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'meta-description', 'catalog.lists.id', '' ) ) ); ?>"
								v-model="item['catalog.lists.id']['meta-description']" />
	...
	<div class="card-tools-more">
		<div class="btn btn-primary btn-card-more act-add fa" tabindex="<?= $this->get( 'tabindex' ); ?>"
			title="<?= $enc->attr( $this->translate( 'admin', 'Insert new entry (Ctrl+I)') ); ?>"
				v-on:click="addItem('catalog.lists.id')" >
		</div>
	</div>
</div>
