...
/** admin/jqadm/catalog/liststype/fields
...
$default = $this->config( 'admin/jqadm/catalog/liststype/fields', $default );
$fields = $this->session( 'aimeos/admin/jqadm/catalog/liststype/fields', $default );
...
<nav class="main-navbar">
	...
	<?= $this->partial(
		$this->config( 'admin/jqadm/partial/navsearch', 'common/partials/navsearch-default.php' ), [
			'filter' => $this->session( 'aimeos/admin/jqadm/catalog/liststype/filter', [] ),
...
<?= $this->partial(
		...
		'page' => $this->session( 'aimeos/admin/jqadm/catalog/liststype/page', [] )]
	);
?>

<form class="list-catalog" method="POST" action="<?= $enc->attr( $this->url( $target, $controller, $action, $params, [], $config ) ); ?>">
	<?= $this->csrf()->formfield(); ?>
		...
		<thead class="list-header">
			<tr>
				<?= $this->partial(
						...
						['fields' => $fields, 'params' => $params, 'data' => $columnList, 'sort' => $this->session( 'aimeos/admin/jqadm/catalog/liststype/sort' )]
					);
				?>
		...
		<tbody>
			...
			<?= $this->partial(
				$this->config( 'admin/jqadm/partial/listsearch', 'common/partials/listsearch-default.php' ), [
					'fields' => $fields, 'filter' => $this->session( 'aimeos/admin/jqadm/catalog/liststype/filter', [] ),
					'data' => [
						...
						'catalog.ctime' => ['op' => '>=', 'type' => 'datetime-local'],
						'catalog.mtime' => ['op' => '>=', 'type' => 'datetime-local'],
						'catalog.editor' => [],
					]
				] );
			?>
