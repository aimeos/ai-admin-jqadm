...
<div id="image" class="item-image tab-pane fade" role="tabpanel" aria-labelledby="image">
	<div id="item-image-group" role="tablist" aria-multiselectable="true">
		...
		<?php foreach( $this->get( 'imageData/service.lists.id', [] ) as $idx => $id ) : ?>

			<div class="group-item card <?= $this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ); ?>">
				<input class="item-listid" type="hidden" name="<?= $enc->attr( $this->formparam( array( 'image', 'service.lists.id', '' ) ) ); ?>" value="<?= $enc->attr( $id ); ?>" />
				...
				<div id="item-image-group-item-<?= $enc->attr( $idx ); ?>" class="card-header header  <?= ( $idx !== 0 ? 'collapsed' : '' ); ?>" role="tab"
					...
					<div class="card-tools-right">
						<?php if( !$this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ) ) : ?>
				...
				<div id="item-image-group-data-<?= $enc->attr( $idx ); ?>" class="card-block collapse row <?= ( $idx === 0 ? 'show' : '' ); ?>"
					...
					<div class="col-xl-6">
						<div class="form-group row image-preview">
							<input class="item-refid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'image', 'service.lists.refid', '' ) ) ); ?>"
								value="<?= $enc->attr( $this->get( 'imageData/service.lists.refid/' . $idx ) ); ?>" />
							...
							<div class="form-group row mandatory">
								...
								<div class="col-sm-8">
									<select class="form-control custom-select item-typeid" required="required" tabindex="<?= $this->get( 'tabindex' ); ?>"
										...
										<?= $this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ); ?> >
										<option value="">
							...
							<div class="form-group row mandatory">
								...
								<div class="col-sm-8">
									<select class="form-control custom-select listitem-typeid" required="required" tabindex="<?= $this->get( 'tabindex' ); ?>"
										name="<?= $enc->attr( $this->formparam( array( 'image', 'service.lists.typeid', '' ) ) ); ?>"
										<?= $this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ); ?> >

										<?php foreach( $this->get( 'imageListTypes', [] ) as $id => $typeItem ) : ?>
											<option value="<?= $enc->attr( $id ); ?>" <?= $selected( $this->get( 'imageData/service.lists.typeid/' . $idx ), $id ); ?> >
												<?= $enc->html( $typeItem->getLabel() ); ?>
											</option>
										<?php endforeach; ?>
									</select>
						...
						<div class="form-group row optional">
							...
							<div class="col-sm-8">
								<input class="form-control listitem-datestart" type="datetime-local" tabindex="<?= $this->get( 'tabindex' ); ?>"
									name="<?= $enc->attr( $this->formparam( array( 'image', 'service.lists.datestart', '' ) ) ); ?>"
									placeholder="<?= $enc->attr( $this->translate( 'admin', 'YYYY-MM-DD hh:mm:ss (optional)' ) ); ?>"
									value="<?= $enc->attr( str_replace( ' ', 'T', $this->get( 'imageData/service.lists.datestart/' . $idx ) ) ); ?>"
									<?= $this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ); ?> />
							</div>
							<div class="col-sm-12 form-text text-muted help-text">
						...
						<div class="form-group row optional">
							...
							<div class="col-sm-8">
								<input class="form-control listitem-dateend" type="datetime-local" tabindex="<?= $this->get( 'tabindex' ); ?>"
									name="<?= $enc->attr( $this->formparam( array( 'image', 'service.lists.dateend', '' ) ) ); ?>"
									placeholder="<?= $enc->attr( $this->translate( 'admin', 'YYYY-MM-DD hh:mm:ss (optional)' ) ); ?>"
									value="<?= $enc->attr( str_replace( ' ', 'T', $this->get( 'imageData/service.lists.dateend/' . $idx ) ) ); ?>"
									<?= $this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ); ?> />
							</div>
							<div class="col-sm-12 form-text text-muted help-text">
					...
					<div class="col-xl-6 content-block secondary <?= $this->site()->readonly( $this->get( 'imageData/service.lists.siteid/' . $idx ) ); ?>">
		...
		<div class="group-item card prototype">
			<input class="item-listid" type="hidden" name="<?= $enc->attr( $this->formparam( array( 'image', 'service.lists.id', '' ) ) ); ?>" value="" disabled="disabled" />
