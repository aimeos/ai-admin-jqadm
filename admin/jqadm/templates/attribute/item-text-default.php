...
<div id="text" class="item-text content-block tab-pane fade" role="tablist" aria-labelledby="text">
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-name-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'name', 'attribute.lists.id', '' ) ) ); ?>"
								v-model="item['attribute.lists.id']['name']" />
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-short-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'short', 'attribute.lists.id', '' ) ) ); ?>"
								v-model="item['attribute.lists.id']['short']" />
					...
					<div class="form-group row optional">
						...
						<div class="col-sm-8">
							<input class="item-long-listid" type="hidden"
								name="<?= $enc->attr( $this->formparam( array( 'text', 'long', 'attribute.lists.id', '' ) ) ); ?>"
								v-model="item['attribute.lists.id']['long']" />
	...
	<div class="card-tools-more">
		<div class="btn btn-primary btn-card-more act-add fa" tabindex="<?= $this->get( 'tabindex' ); ?>"
			...
			v-on:click="addItem('attribute.lists.id')" >
		</div>
	</div>
</div>
