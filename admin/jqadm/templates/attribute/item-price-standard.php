...
<div id="price" class="item-price tab-pane fade" role="tablist" aria-labelledby="price">
	...
	<div id="item-price-group"
		...
		<div class="group-list" role="tablist" aria-multiselectable="true">
			<div v-is="'draggable'" v-model="items" group="price" handle=".act-move">
					...
					<div v-bind:id="'item-price-group-data-' + idx" v-bind:class="item['_show'] ? 'show' : 'collapsed'"
						...
						<div class="col-xl-6">
							...
							<div class="form-group row mandatory">
								...
								<div class="col-sm-8">
									<div v-is="'taxrates'" v-bind:key="idx"
						...
						<div class="col-xl-6">
							...
							<?php if( ( $currencies = $this->get( 'priceCurrencies', map() ) )->count() !== 1 ) : ?>
								<div class="form-group row mandatory">
									...
									<div class="col-sm-8">
										<select v-is="'select-component'" required class="form-control form-select item-currencyid" tabindex="<?= $enc->attr( $this->get( 'tabindex' ) ); ?>"
						...
						<div v-show="item['_ext']" class="col-xl-6 secondary" v-bind:class="{readonly: item['attribute.lists.siteid'] != siteid}">
							<config-table v-bind:tabindex="<?= $this->get( 'tabindex' ); ?>"
								...
								v-bind:name="'<?= $enc->attr( $this->formparam( ['price', '_idx_', 'config', '_pos_', '_key_'] ) ); ?>'"
