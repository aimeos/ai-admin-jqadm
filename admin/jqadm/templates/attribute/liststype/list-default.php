...
/** admin/jqadm/attribute/liststype/fields
...
$default = $this->config( 'admin/jqadm/attribute/liststype/fields', $default );
$fields = $this->session( 'aimeos/admin/jqadm/attribute/liststype/fields', $default );
...
<nav class="main-navbar">
	...
	<?= $this->partial(
		$this->config( 'admin/jqadm/partial/navsearch', 'common/partials/navsearch-default.php' ), [
			'filter' => $this->session( 'aimeos/admin/jqadm/attribute/liststype/filter', [] ),
...
<?= $this->partial(
		...
		'page' => $this->session( 'aimeos/admin/jqadm/attribute/liststype/page', [] )]
	);
?>
		...
		<thead class="list-header">
			<tr>
				<?= $this->partial(
						...
						['fields' => $fields, 'params' => $params, 'data' => $columnList, 'sort' => $this->session( 'aimeos/admin/jqadm/attribute/liststype/sort' )]
					);
				?>
		...
		<tbody>
			...
			<?= $this->partial(
				$this->config( 'admin/jqadm/partial/listsearch', 'common/partials/listsearch-default.php' ), [
					'fields' => $fields, 'filter' => $this->session( 'aimeos/admin/jqadm/attribute/liststype/filter', [] ),
					'data' => [
