...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testBatch()
	{
		$param = array(
			'site' => 'unittest',
			'item' => array(
				'service.type.domain' => 'product',
				'service.type.position' => 1,
	...
	public function testCopy()
	{
		...
		$param = ['type' => 'unittest', 'id' => $manager->find( 'payment', [], 'service' )->getId()];
		$helper = new \Aimeos\Base\View\Helper\Param\Standard( $this->view, $param );
		$this->view->addHelper( 'param', $helper );

		$result = $this->object->copy();

		$this->assertStringContainsString( 'payment', $result );
	}
	...
	public function testSave()
	{
		...
		$param = array(
			...
			'item' => array(
				...
				'service.type.code' => 'jqadm@test',
				'service.type.label' => 'jqadm test',
			),
		);
		...
		$manager->delete( $manager->find( 'jqadm@test', [], 'service' )->getId() );
	...
	protected function getViewNoRender( $real = true )
	{
		...
		$param = ['site' => 'unittest', 'id' => $real ? $manager->find( 'payment', [], 'service' )->getId() : -1];
